...
<!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
  ...
  <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#multiple">
    add tasks
  </button>
  <!-- Modal add-->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">New tasks to do</h1>
      ...
      <div class="modal-content">
        ...
        <div class="container text-center">
            <div class="row d-flex justify-content-around mt-4">
                <div class="card  text-light mb-3" id="ob" style="max-width: 18rem; background-color:rgba(255,255,255,0.8);">
                
                    <div  class="card-header text-dark">TO DO(<?php echo $todo_stats?>)</div>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="todo-tasks" >
                            ...
                            <div>
                              ...
                              <a href="../task/delete/<?= $data['id_task']?>"><i class="bi bi-trash-fill text-danger"></i></a>
                            </div>
                        </div>
                    </div>
                    <?php }
                  ...
                  <div class="card text-light mb-3" style="max-width: 18rem; background-color:rgba(255,255,255,0.8);" >
                    <div class="card-header text-dark">DOING(<?php echo $doing_stats?>)</div>
                    <?php foreach($datas as $data) {
                  ...
                  <div class="card text-light mb-3" style="max-width: 18rem; background-color:rgba(255,255,255,0.8);">
                    <div class="card-header text-dark">DONE(<?php echo $done_stats?>)</div>
                    <?php foreach($datas as $data) {
...
<div class="modal fade" id="edit_form" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php BURL ?>/task" method="POST"  style="
    display: flex;
